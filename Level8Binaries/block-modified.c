...
int main(int argc, char ** argv) {
    ...
    puts("*********************************************");
    puts("This is an unsigned binary from the internet.");
    puts("Continue to delete ALL files now? (y/N)");
    int64_t n; // bp-2720, 0x400760
    getline(&lineptr, (size_t *)&n, stdin);
    if (strcmp("y\n", lineptr) != 0) {
        // 0x4007ea
    ...
    memcpy((char *)&v5, (char *)&g3, 50);
    int64_t v6; // bp-2512, 0x400760
    memcpy((char *)&v6, (char *)&g4, 50);
    ...
    int64_t v16; // 0x4008c2
    int64_t v17; // bp-636, 0x400760
    int64_t v18; // 0x4008ca
    if (system_rc == 0) {
        // 0x40090f
        memcpy((char *)&v15, (char *)&g7, 153);
        memcpy((char *)&v17, (char *)&g8, 153);
        int64_t v19 = 0;
